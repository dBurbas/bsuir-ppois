...
protected:
    void SetUp() override {
        ...
        test_dict += "Object-Oriented-Programming:Объектно-Ориентированное-Программирование";
...
TEST_F(DictionaryFixture, EqualityOperatorEqualDictionaries) {
    ...
    dict_to_compare += "Object-Oriented-Programming:Объектно-Ориентированное-Программирование";
