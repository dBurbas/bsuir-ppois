...
public:
    ...
    */
    ...
    /**
     * @brief Copy assignment operator. Replaces current tree with a copy of another.
     * @param other Tree to copy from
     ...
     * 
     * @tparam Func Function type with signature void(const KeyType&, const ValueType&)
